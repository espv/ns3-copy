...
int main(int argc, char** argv) {
    ...
    cmd.AddValue ("TraceMetadataFileName", "Metadata json file for the trace", trace_metadata_fn);
...
//    positionAlloc2->Add (Vector (925.0, 1310.0, 0.0));
    ...
    for(uint32_t i = 0; i < numStationary; i++)
    {
        ...
        else if (i < 2)//data generator
        {
            ...
            dcepApps.Get(i)->SetAttribute("TraceMetadataFileName", StringValue(trace_metadata_fn));
        }
    }
