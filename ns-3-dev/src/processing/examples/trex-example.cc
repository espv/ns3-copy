...
namespace ns3 {
    NS_LOG_COMPONENT_DEFINE("TRexExample");
    // For debug
    extern bool debugOn;
}
...
int main(int argc, char *argv[])
{
  ...
  LogComponentEnable ("TRex", LOG_LEVEL_INFO);
...
#define CC2420_MODEL 0
  ...
  CC2420Helper cc2420;
    ...
    // TRexMote 3 receives the packet from mote 2.
    ...
    TRex *mote1 = new TRex(nodes.Get(0), InetSocketAddress(interfaces.GetAddress(0), 9), netDevice1, &ps);
    TRex *mote2 = new TRex(nodes.Get(1), InetSocketAddress(interfaces.GetAddress(1), 9),
                               InetSocketAddress(interfaces.GetAddress(2), 9), netDevice2, &ps);
    TRex *mote3 = new TRex(nodes.Get(2), InetSocketAddress(interfaces.GetAddress(2), 9), netDevice3, &ps);
    ns3::debugOn = false;
    ...
    netDevice2->SetMessageCallback(MakeCallback(&TRex::HandleRead, mote2));
  ...
  Ptr<ExecEnvHelper> eeh = CreateObjectWithAttributes<ExecEnvHelper>(
    ...
    TRexProtocolStack *protocolStack = &ps;

    TRex *mote1 = new TRex(c.Get(0), &ps);
    ScheduleInterrupt (mote1->GetNode(), Create<Packet>(0), "HIRQ-12", Seconds(0));
    TRex *mote2 = new TRex(c.Get(1), &ps);
    ScheduleInterrupt (mote2->GetNode(), Create<Packet>(0), "HIRQ-12", Seconds(0));
    TRex *mote3 = new TRex(c.Get(2), &ps);
    ...
    while (!trace_file.eof()) {
        ...
        //                    &TRexProtocolStack::GeneratePacket, protocolStack, ps.packet_size, curSeqNr++, mote1, mote2, mote3);
  ...
  NS_LOG_INFO ("Milliseconds it took to simulate: " << t);
    ...
    NodeContainer c;
    int numberTRexMotes = 1;
    ps.pps = 1;
    ps.duration = 100;
    memset(&c, 0, sizeof(NodeContainer));
    c.Create(numberTRexMotes);
   ...
   // eeh1->Install(ps.deviceFile, c.Get(10));
    ...
    for (int i = 0; i < numberTRexMotes; i++) {
        ScheduleInterrupt (c.Get(i), Create<Packet>(0), "HIRQ-12", Seconds(0));
        protocolStack->GenerateTraffic(c.Get(i), ps.packet_size, new TRex(c.Get(i), &ps),
                                       new TRex(c.Get(i), &ps), new TRex(c.Get(i), &ps));
    }
    install_time = clock() - install_time;
    ns3::debugOn = false;
/*, &ps
    TRex *moteFrom0 = new TRex(c.Get(0), &ps);
    TRex *moteFrom1 = new TRex(c.Get(1), &ps);
    TRex *moteFrom2 = new TRex(c.Get(2), &ps);
    TRex *moteFrom3 = new TRex(c.Get(3), &ps);
    TRex *moteFrom4 = new TRex(c.Get(4), &ps);
    TRex *moteFrom5 = new TRex(c.Get(5), &ps);
    TRex *moteFrom6 = new TRex(c.Get(6), &ps);
    TRex *moteFrom7 = new TRex(c.Get(7), &ps);
    TRex *moteFrom8 = new TRex(c.Get(8), &ps);
    TRex *moteFrom9 = new TRex(c.Get(9), &ps);

    TRex *moteInt0 = new TRex(c.Get(10), &ps);
    TRex *moteInt1 = new TRex(c.Get(11), &ps);
    TRex *moteInt2 = new TRex(c.Get(12), &ps);
    TRex *moteInt3 = new TRex(c.Get(13), &ps);
    TRex *moteInt4 = new TRex(c.Get(14), &ps);
    TRex *moteInt5 = new TRex(c.Get(15), &ps);
    TRex *moteInt6 = new TRex(c.Get(16), &ps);
    TRex *moteInt7 = new TRex(c.Get(17), &ps);
    TRex *moteInt8 = new TRex(c.Get(18), &ps);
    TRex *moteInt9 = new TRex(c.Get(19), &ps);

    TRex *moteTo0 = new TRex(c.Get(20), &ps);
    TRex *moteTo1 = new TRex(c.Get(21), &ps);
    TRex *moteTo2 = new TRex(c.Get(22), &ps);
    TRex *moteTo3 = new TRex(c.Get(23), &ps);
    TRex *moteTo4 = new TRex(c.Get(23), &ps);
    TRex *moteTo5 = new TRex(c.Get(24), &ps);
    TRex *moteTo6 = new TRex(c.Get(25), &ps);
    TRex *moteTo7 = new TRex(c.Get(26), &ps);
    TRex *moteTo8 = new TRex(c.Get(27), &ps);
    TRex *moteTo9 = new TRex(c.Get(28), &ps);
    ...
    NS_LOG_INFO ("2 " << ps.packet_size << " " << ps.pps << " " <<
                 (ps.nr_packets_dropped_ip_layer/(float)ps.nr_packets_total)*100 << "\n");
    NS_LOG_INFO ("3 " << ps.packet_size << " " << ps.pps << " " << ps.total_intra_os_delay/(float)ps.nr_packets_total << "\n");
    NS_LOG_INFO ("Microseconds to simulate " << numberTRexMotes << " motes for " << ps.duration << " seconds: " <<
    ...
    for (int i = 125; i >= 36; i-=8) {
        ...
        for (int j = 0; j <= 150; j++) {
            ...
            TRex *mote1 = new TRex(node_container.Get(0));
            TRex *mote2 = new TRex(node_container.Get(1));
            TRex *mote3 = new TRex(node_container.Get(2));
            ...
            memset(mote1, 0, sizeof(TRex));
            delete mote1;
            memset(mote2, 0, sizeof(TRex));
            delete mote2;
            memset(mote3, 0, sizeof(TRex));
            delete mote3;
