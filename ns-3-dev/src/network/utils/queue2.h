...
/**
 * \ingroup network
 * \defgroup queue Queue2
 */
/**
 * \ingroup queue
 * \brief Abstract base class for packet Queue2s
 * 
 * This class defines the base APIs for packet queues in the ns-3 system
 */
class Queue2 : public Object
{
public:
  ...
  /**
   * Place a packet into the rear of the Queue2
   * \param p packet to enqueue
   * \return True if the operation was successful; false otherwise
   */
  bool Enqueue (Ptr<Packet> p);
  /**
   * Remove a packet from the front of the Queue2
  ...
  /**
   * \return The number of packets currently stored in the Queue2
   */
  uint32_t GetNPackets (void) const;
  /**
   * \return The number of bytes currently occupied by the packets in the Queue2
   */
  uint32_t GetNBytes (void) const;

  /**
   * \return The total number of bytes received by this Queue2 since the
  ...
  /**
   * \return The total number of packets received by this Queue2 since the
   * simulation began, or since ResetStatistics was called, according to 
   * whichever happened more recently
   */
  uint32_t GetTotalReceivedPackets (void) const;
  /**
   * \return The total number of bytes dropped by this Queue2 since the
   * simulation began, or since ResetStatistics was called, according to 
   * whichever happened more recently
   */
  ...
  // average
  double GetQueue2SizeAverage (void);
  ...
  // variance
  double GetQueue2SizeVariance (void);
