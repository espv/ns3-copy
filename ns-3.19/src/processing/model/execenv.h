...
public:
  ...
  // service to call.
  std::map<std::string, std::queue<std::pair<Ptr<SEM>, ProgramLocation> > *> serviceQueues;
  std::map<std::queue<std::pair<Ptr<SEM>, ProgramLocation> > *, std::string> serviceQueueNames;
  std::vector<std::queue<std::pair<Ptr<SEM>, ProgramLocation> > *> serviceQueueOrder;
