  ...
  if (!m_socket)
    {
      ...
      std::cout << "m_peerAddress: " << m_peerAddress << std::endl;
...
void Ping6::Send ()
{
  ...
  std::cout << "Ping6::Send, time: " << Simulator::Now() << std::endl;
  ...
  std::cout << "Sent " << p->GetSize () << " bytes to " << m_peerAddress << std::endl;
...
{
  std::cout << "ping6::HandleRead, time: " << Simulator::Now() << std::endl;
