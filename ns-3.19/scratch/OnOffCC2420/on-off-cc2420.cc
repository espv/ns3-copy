...
NS_LOG_COMPONENT_DEFINE("OnOffCC2420Example");

/*
 * Simulates an OnOffApplication, which sends traffic to a PacketSink over a
 * CC2420 medium. Since CC2420 has a fixed data rate of 250 kbps, this can
...
main(int argc, char *argv[])
{
	...
	devices = cc2420.Install(nodes, false); // regular CC2420NetDevice
	...
	OnOffHelper onoff ("ns3::TcpSocketFactory",InetSocketAddress(interfaces.GetAddress(1), 9));
	...
	PacketSinkHelper pktSink("ns3::TcpSocketFactory",InetSocketAddress (Ipv4Address::GetAny (), 9));
